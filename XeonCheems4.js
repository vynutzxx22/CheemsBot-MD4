...
if (!('templateVideo' in setting)) setting.templateVideo = false
  ...
  // FAKE TEXT IMG
const textImg = (teks) => {
XeonBotInc.sendMessage(m.chat, { text :teks, }, {quoted: m, thumbnail: fs.readFileSync('./XeonMedia/theme/origami4.jpeg')}) 
}
...
"ptt": "true"
  ...
  //group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/origami4.jpeg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/origami2.jpeg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Guess The Music 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
      ...
      deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak caklontong', buttonText: { displayText: 'Cak Lontong' }, type: 1 }], `🎮 Guess The Blank 🎮\n\nCorrect Answer 🎉\n*${deskripsi}*\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
    ...
    delete caklontong_desk[m.sender.split('@')[0]]
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Guess The Sentence 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await XeonBotInc.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Guess The Lyrics 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, XeonBotInc.user.name, m)
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await XeonBotInc.send5ButImg(from, `` + '' + teksehmazeh, `© ${botname}`, XeonBotInc, [{"urlButton": {"displayText": "🌐 My Web","url": `${ytname}`}}])
  }
  break
...
if (isBanChat) return reply(mess.banChat)
                ...
                user.afkReason = text
                reply(`${m.pushName} Telah AFK  Dengan Alasan${text ? ': ' + text : ''}`)
            }
            break 
...
if (isBanChat) return reply(mess.banChat)
            ...
            let poin_lose = 10
            let timeout = 60000
            if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) return replay(`Selesaikan suit mu yang sebelumnya`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) XeonBotInc.sendText(m.chat, `_Waktu Suit Berakhir_\nPemain Yang Kamu Tantang Tidak Menerima Tantangan Suitmu`, m)
            delete this.suit[id]
...
if (!text) return replay(`Contoh : ${prefix + command} lagu\n\nOption : \n1. lagu\n2. gambar\n3. kata\n4. kalimat\n5. lirik\n6.lontong`)
                if (args[0] === "lagu") {
                    ...
                    XeonBotInc.sendText(m.chat, `Apa Judul Lagu Tersebut?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
...
XeonBotInc.sendMessage(from, { text: `Pertanyaan : Apakah ${q}\nJawaban : ${kah}` }, { quoted: m })
          ...
          break
case 'bisakah':
        if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} wibu mempunyai teman real life?`)
          const bisa = ['Bisa','Gak Bisa','Gak Bisa Ajg Aaokawpk','TENTU PASTI KAMU BISA!!!!','Gk tau tau bro soalnya lu wibu sih']
          const ga = bisa[Math.floor(Math.random() * bisa.length)]
XeonBotInc.sendMessage(from, { text: `Pertanyaan : Bisakah ${q}\nJawaban : ${ga}` }, { quoted: m })

          break
case 'bagaimanakah': case 'bagaimana':
        if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} kehidupan wibu sehari-hari?`)
          const gimana = ['Gak Gimana2', 'Sulit Itu Bro', 'Maaf Bot Tidak Bisa Menjawab', 'Coba Deh Cari Di Gugel','astaghfirallah Beneran???','Pusing ah','Owhh Begitu:(','Yang Sabar Ya Bos:(','Gimana yeee','Pikir aja sendiri masalah masalah lu ngapain gw yg sibuk']
          const ya = gimana[Math.floor(Math.random() * gimana.length)]
XeonBotInc.sendMessage(from, { text: `Pertanyaan : Bagaimanakah ${q}\nJawaban : ${ya}` }, { quoted: m })
...
XeonBotInc.sendMessage(from, { text: `Nama : ${q}\nPersentase Kegantengan : *${teng}%*` }, { quoted: m })
...
XeonBotInc.sendMessage(from, { text: `Nama : ${q}\nPersentase Kecantikan : *${tik}%*` }, { quoted: m })
          break
          case 'charactercheck':
          if (isBan) return reply(mess.ban)       
if (isBanChat) return reply(mess.banChat)
...
case 'kapankah': case 'kapan':
        if (!q) return reply(`Penggunaan ${command} Pertanyaan\n\nContoh : ${command} ras wibu didunia ini musnah?`)
...
XeonBotInc.sendMessage(from, { text: `Pertanyaan : Kapankah ${q}\nJawaban : *${kapankah}*` }, { quoted: m })
          break
case 'wangy':
...
if (isBanChat) return reply(mess.banChat)
    if (!m.isGroup) return replay(`${mess.group}`)
    if (!Number(text)) return replay `Maaf, fitur untuk sementara dinonaktifkan untuk mencegah nomor bot terkena banned`
                /*if (!isBotAdmins) return replay(`${mess.botAdmin}`)
                if (!isAdmins && !isCreator) return replay(mess.admin)
...
if (isBanChat) return reply(mess.banChat)
                ...
                break
           case 'setppgroup': case 'setppgrup': case 'setgcpp': {
            if (isBan) return reply(mess.ban)       
if (isBanChat) return reply(mess.banChat)
                if (!m.isGroup) return replay(`${mess.group}`)
                if (!isAdmins && !isCreator) return replay(mess.admin)
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'NGETES YANG MASIH ON SIAPA AJA WIBU'}*\n\n`
...
if (!isCreator) return replay(mess.owner)
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "916909137213-1604595598@g.us"}, "message": {orderMessage: {itemCount: 999999999,status: 200, thumbnail: fs.readFileSync('./XeonMedia/theme/origami.jpg'), surface: 200, message: `${ownername}'s Broadcast`, orderTitle: `${botname}`, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
case 'femdom': case 'cum': case 'ero': case 'cuckold': case 'hentaigif': case 'bdsm': 
case 'ahegao': case 'ass': case 'orgy': case 'panties': case 'pussy': case 'thighs': case 'yuri': case 'tentacles':
case 'sfwneko': case 'maid': case 'mobilewall': case 'netorare': case 'zettairyouiki':
if (isBan) return reply(mess.ban)       
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
...
try{
reply(mess.wait)
NoHorny = await fetchJson(`https://zenzapis.xyz/api/morensfw/${command}?apikey=743648144832`)
Ngocok = await fetchJson(`https://zenzapis.xyz/api/morensfw/${command}?apikey=a53a6f436b`)
YesHorny = await getBuffer(NoHorny.result)
NgocokLagi = await getBuffer(Ngocok.result)
XeonBotInc.sendMessage(from, {image:YesHorny},{quoted:m}),
XeonBotInc.sendMessage(from, {image:NgocokLagi},{quoted:m})
} catch (e) {error("Error")}  
break
case 'hmanga':
if (isBan) return reply(mess.ban)       
...
try{
reply(mess.wait)
NoHorny = await fetchJson(`https://zenzapis.xyz/api/morensfw/manga?apikey=743648144832`)
Ngocok = await fetchJson(`https://zenzapis.xyz/api/morensfw/manga?apikey=a53a6f436b`)
YesHorny = await getBuffer(NoHorny.result)
NgocokLagi = await getBuffer(Ngocok.result)
XeonBotInc.sendMessage(from, {image:YesHorny},{quoted:m}),
XeonBotInc.sendMessage(from, {image:NgocokLagi},{quoted:m})
...
spankd = await axios.get(`https://nekos.life/api/v2/img/spank`)                                   
  let spbuff = await getBuffer(spankd.data.url)  
        await XeonBotInc.sendMessage(m.chat,{video: spbuff, gifPlayback:true},{ quoted:m }).catch(err => {
                    return reply('Error!')
                                    })
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
 waifudd = await axios.get(`https://waifu.pics/nsfw/${command}`)       
 let trapbot = [
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
    waifudd = await axios.get(`https://waifu.pics/nsfw/waifu`)         
 let nwaifubot = [
    {buttonId: `.nwaifu`, buttonText: {displayText: `Next ⚡`}, type: 1},
    ]
  let button4Messages = {
   image: {url:waifudd.data.url},
   caption:  `Here you go!`,
...
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
    waifudd = await axios.get(`https://waifu.pics/sfw/nom`)
 let xxhnekobot = [
...
case 'neko2':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
   waifud = await axios.get('https://waifu.pics/sfw/neko')
                var wbutsss = [
...
case 'animecry':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/cry`)
                           var wbutt1sss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animekill':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/kill`)
                           var wbuttszzss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animelick':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/lick`)
                           var wbuttszz12ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animebite':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/bite`)
                           var wbuttszz123ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animeyeet':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/yeet`)
                           var wbuttszz124ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animebonk':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/bonk`)
                           var wbuttszz126ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animewink':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/wink`)
                           var wbuttszz127ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animepoke':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/poke`)
                           var wbuttszz128ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animesmile':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/smile`)
                           var wbuttszz129ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animewave':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/wave`)
                           var wbuttszz1210ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animeawoo':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/awoo`)
                           var wbuttszz1211ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animeblush':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/blush`)
                           var wbuttszz1212ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animesmug':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/smug`)
                           var wbuttszz1213ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animeglomp':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/glomp`)
                           var wbuttszz1214ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animehappy':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/happy`)
                           var wbuttszz1215ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animedance':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/dance`)
                           var wbuttszz1216ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animecringe':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/cringe`)
                           var wbuttszz1217ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animehighfive':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/highfive`)
                           var wbuttszz1218ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animehandhold':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/handhold`)
                           var wbuttszz1219ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'animemegumin':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
 waifudd = await axios.get(`https://waifu.pics/sfw/megumin`)
                           var wbuttszz1220ss = [
        {buttonId: `.${command}`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
case 'shinobu2':  
 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
                    ud = await axios.get('https://waifu.pics/sfw/shinobu')
var wbutsss = [
...
case 'megumin2':
  ...
  if (isBanChat) return reply(mess.banChat)
reply(mess.wait)            
                    ud = await axios.get('https://waifu.pics/sfw/megumin')
var wbutsss = [
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
   if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
          axios.get(`https://waifu.pics/sfw/${command}`)
          .then(({data}) => {
...
case 'waifu': case 'loli':
  ...
  if (isBanChat) return reply(mess.banChat)
          reply(mess.wait)
          axios.get(`https://waifu.pics/sfw/waifu`)
          .then(({data}) => {
...
break
  ...
  case 'yts': case 'ytsearch': {
   if (isBan) return reply(mess.ban)        
if (isBanChat) return reply(mess.banChat)
if (!args.join(" ")) return replay(`Example : ${prefix + command} metallica creeping death`)
...
break
            break
case 'lyrics': case 'lirik': case 'lyric': {
                  if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
      if (!text) return reply(`Use example ${prefix}lirik Stay`)
  reply(mess.wait)
...
break
  ...
  if (isBanChat) return reply(mess.banChat)
            ...
            case 'ramalanjodoh': case 'ramaljodoh': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn, 7, 7, 2005, Keqing, 16, 11, 2004`)
  ...
  if (isBanChat) return reply(mess.banChat)
            ...
            case 'artinama': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn Ardianta`)
            ...
            case 'kecocokannama': case 'cocoknama': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn, 7, 7, 2005`)
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn|Keqing`)
  ...
  if (isBanChat) return reply(mess.banChat)
            ...
            case 'fengshui': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn, 1, 2005\n\nNote : ${prefix + command} Name, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`)
  ...
  if (isBanChat) return reply(mess.banChat)
            ...
            case 'peruntungan': {
                 if (isBan) return reply(mess.ban)
  if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} Alvyn, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Name, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`)
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
  ...
  if (isBanChat) return reply(mess.banChat)
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
            case 'tes': case 'runtime': case 'test': {
      if (isBan) return reply(mess.ban)        
if (isBanChat) return reply(mess.banChat)
      return reply(`⏰ *Sekarang Jam :*\n★ *${wib}*\n★ *${wita}*\n★ *${wit}*\n\n*🚀 Bot Sudah Aktif Selama : ${runtime(process.uptime())}*`)
}
break
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                ...
                "rows": [
                  ...
                  {
                    "title": "🧙PEMILIK BOT",
                    "description": "Nomor Pemilik Bot, Chat Yang Gak Jelas Tidak Akan Direspon",
                    "rowId": `${prefix}owner`
                    },
                  {
                  ...
                  {
                    "title": "📖 RULES BOT",
                    "description": "Sebelum Menggunakan Bot Ada Baiknya Membaca Rules Bot Terlebih Dulu",
                    "rowId": `${prefix}rules`
                    }                  
                ]
              },
              {
                ...
                "rows": [
                  ...
                  {
                    "title": "│👥│GROUP MENU",
                    "description": "Untuk Pengelolaan Grup",
                  ...
                  {
                    "title": "│🎵│SOUND MENU",
                    "description": "Gacha Suara Random",
                    "rowId": `${prefix}soundmenu`
                  },
                  {
                    "title": "│⬇️│DOWNLOADER MENU",
                    "description": "Untuk Download Video YouTube Atau Tiktok",
                  ...
                  {
                    "title": "│🔍│SEARCH MENU",
                    "description": "Mencari Sesuatu Dari Bot",
                  ...
                  },
                  {
                    ...
                    "description": "Gacha Gambar Random",
                    "rowId": `${prefix}randomimagemenu`
                  },
                  {
                    "title": "│🖼️│IMAGE EFFECT MENU",
                    "description": "Membuat Gambar Efek",
                    "rowId": `${prefix}imageeffectmenu`
                  },
                    {
                    "title": "│⛩️│ANIME MENU",
                    "description": "Menu Untuk Para Wibu Stress & Halu",
                    "rowId": `${prefix}animemenu`
                    },
                    {
                    "title": "│😀│EMOTE MENU",
                    "description": "Berbagai Macam Emote",
                    "rowId": `${prefix}emotemenu`
                    },
                    {
                    "title": "│⛩️│ANIME STIKER MENU",
                    "description": "Menu Stikernya Wibu",
                    "rowId": `${prefix}animestickermenu`
                       },
                  {
                    "title": "│🔞│NSFW MENU",
                    "description": "Menu Haram Untuk Para Pendosa Dan Colikiawan",
                    "rowId": `${prefix}nsfwmenu`
                       },
                    {
                    "title": "│⚔️│RPG MENU",
                    "description": "Menu Berpetualang Di Bot",
                    ...
                    "description": "Menu Untuk Mengkonversi Sesuatu",
                    "rowId": `${prefix}convertmenu`
                    },
                    {
                      "title": "│♻️│DATABASE MENU",
                    "description": "Melihat Yang Ada Di Database Bot",
                    ...
                    {
                      "title": "│🕊️│HOROSCOPE MENU",
                    "description": "Menu Ramalan Yang Bukan Dari Tuhan",
                ...
                "rows": [
                  {
                    ...
                    "description": "Menu Gabut Ngechat Org Gk Jelas",
...
await XeonBotInc.send5ButImg(from, `*『 🧙 OWNER MENU 』*
▷ ${prefix}self
▷ ${prefix}public
▷ ${prefix}antitag
▷ ${prefix}ban [add/del]
...
await XeonBotInc.send5ButImg(from, `*『 👥 GROUP MENU 』*  
▷ ${prefix}groupsetting
▷ ${prefix}linkgroup
▷ ${prefix}ephemeral [option]
▷ ${prefix}setgcpp [image]
...
await XeonBotInc.send5ButImg(from, `*『 🌱 RPG MENU 』*  
▷ ${prefix}hunt
▷ ${prefix}mine
▷ ${prefix}fish
▷ ${prefix}heal
...
await XeonBotInc.send5ButImg(from, `*『 ⬇️ DOWNLOADER MENU 』*
▷ ${prefix}instagram [url]
▷ ${prefix}igtv [url]
▷ ${prefix}igstory [username]
▷ ${prefix}facebook [url]
...
await XeonBotInc.send5ButImg(from, `*『 🔍 SEARCH MENU 』* 
▷ ${prefix}play [query]
▷ ${prefix}song [query]
▷ ${prefix}yts [query]
▷ ${prefix}lyrics [query]
...
await XeonBotInc.send5ButImg(from, `*『 📲 CONVERTER MENU 』*
▷ ${prefix}toimage [reply stick]
▷ ${prefix}sticker [reply img|gif]
▷ ${prefix}take [reply img|gif|stik]
▷ ${prefix}smeme [reply img]
...
await XeonBotInc.send5ButImg(from, `*『 💨 RANDOM IMAGE MENU 』*
▷ ${prefix}coffee
▷ ${prefix}bts
▷ ${prefix}woof
▷ ${prefix}meow
...
await XeonBotInc.send5ButImg(from, `*『 😀 EMOTE MENU 』*
▷ ${prefix}instagramemoji
▷ ${prefix}facebookemoji
▷ ${prefix}iphoneemoji
▷ ${prefix}samsungemoji
...
await XeonBotInc.send5ButImg(from, `*『 🖼️ IMAGE EFFECT MENU 』*
▷ ${prefix}wanted
▷ ${prefix}blur
▷ ${prefix}framed
▷ ${prefix}gayeffect
...
await XeonBotInc.send5ButImg(from, `*『 ⛩️ ANIME MENU 』*
▷ ${prefix}naruto
▷ ${prefix}yaoi
▷ ${prefix}neko2
▷ ${prefix}waifu
...
await XeonBotInc.send5ButImg(from, `*『 ⛩️ ANIME STICKER MENU 』*
▷ ${prefix}loli
▷ ${prefix}bully
▷ ${prefix}cuddle
▷ ${prefix}cry
...
await XeonBotInc.send5ButImg(from, `*『 🔞 NSFW MENU 』*
▷ ${prefix}hentaivideo
▷ ${prefix}hentaigif
▷ ${prefix}hentai
▷ ${prefix}yuri
...
await XeonBotInc.send5ButImg(from, `*『 🐣 FUN MENU 』*
▷ ${prefix}apakah [text
▷ ${prefix}bisakah [text]
▷ ${prefix}bagaimanakah [text]
▷ ${prefix}kapankah [text]
...
await XeonBotInc.send5ButImg(from, `*『 🎵 SOUND MENU 』*
▷ ${prefix}sound1
▷ ${prefix}sound2
▷ ${prefix}sound3
▷ ${prefix}sound4
...
await XeonBotInc.send5ButImg(from, `*『 🎮 GAME MENU 』*
▷ ${prefix}truth
▷ ${prefix}dare
▷ ${prefix}tictactoe
▷ ${prefix}delttt
...
await XeonBotInc.send5ButImg(from, `*『 🛠 TOOLS MENU 』*
▷ ${prefix}translate [text]
▷ ${prefix}fliptext [text]
▷ ${prefix}toletter [number]
...
await XeonBotInc.send5ButImg(from, `*『 📚 DATABASE MENU 』*
▷ ${prefix}setcmd
▷ ${prefix}listcmd
▷ ${prefix}delcmd
▷ ${prefix}lockcmd
...
await XeonBotInc.send5ButImg(from, `*『 🦜 INDO MENU 』*
▷ ${prefix}darkjoke
▷ ${prefix}quotes
▷ ${prefix}animequotes
▷ ${prefix}jalantikus-meme
...
await XeonBotInc.send5ButImg(from, `*『 🕊️ HOROSCOPE MENU 』*
▷ ${prefix}nomorhoki
▷ ${prefix}artimimpi 
▷ ${prefix}artinama 
▷ ${prefix}ramaljodoh 
...
await XeonBotInc.send5ButImg(from, `*『 📋 MAIN MENU 』*
▷ ${prefix}afk
▷ ${prefix}readmore [text]
▷ ${prefix}toviewonce
▷ ${prefix}chatinfo
...
And Thanks to Me (Alvyn)
Who Helped Assemble This Script !!!

━━『  *${ownername}*  』━━` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "🌐 My Web","url": `${ytname}`}},{"urlButton": {"displayText": "📢 My Instagram","url": `${socialm}`}},{"quickReplyButton": {"displayText": "💰 Sewa Bot","id": 'donate'}},{"quickReplyButton": {"displayText": "👤 Owner","id": 'owner'}},{"quickReplyutton": {"displayText": "🔙 Back To List Menu","id": 'command'}}] )
break
case 'rules': case 'snk' :
...
╭─────[ RULES ]─────✧
┴
│1 Dilarang Hina Alvyn / Owner (Orang Yang Punya Bot Ini)
│2 Dilarang Spam Command
│3 Dilarang Kirim Virtex Ke Alvyn (Owner Bot)
...
│10 Dilarang Chat Owner Untuk Pesan Yang Ga Jelas
│11 Dilarang Ngemis Supaya Bot Masuk Ke Grup Lu, Kalau Mau Bot Masuk Ke Grup Lu Ketik .sewabot Atau Chat Owner
┬
╰──────────···
╭─────[ *HUKUM* ]─────✧
┴
│ 1,3,5,10 = Block + banned permanent
│ 2,4,6 & 9 = Banned sementara
│ 3 = War
│ 7 = Block sementara
│ 3 & 5 = Block permanent
┬
